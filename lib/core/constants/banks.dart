...
class BankConstants {
  ...
  static final List<Bank> vietNamBanks = const [
    ...
    Bank(
      id: 6,
      name: 'Ngân hàng TM TNHH MTV Xây dựng Việt Nam',
      code: 'CBB',
      shortName: 'CBBank',
    ...
    Bank(
      id: 8,
      name: 'DBS Bank Ltd - Chi nhánh TP. Hồ Chí Minh',
      code: 'DBS',
      shortName: 'DBSBank',
    ...
    Bank(
      id: 16,
      name: 'Ngân hàng Công nghiệp Hàn Quốc - Chi nhánh TP. HCM',
      code: 'IBK-HCM',
      shortName: 'IBKHCM',
      logo: 'https://cdn.vietqr.io/img/IBK.png',
    ),
    ...
    Bank(
      id: 32,
      name: 'Ngân hàng Standard Chartered Việt Nam',
      code: 'SCVN',
    ...
    Bank(
      id: 55,
      name: 'Ngân hàng Đại chúng Kasikornbank',
      code: 'KBANK',
      shortName: 'KBank',
    ...
    Bank(
      id: 60,
      name: 'Ngân hàng KEB Hana - Chi nhánh TP. HCM',
      code: 'KEBHANAHCM',
