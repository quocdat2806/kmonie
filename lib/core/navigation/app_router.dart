...
class AppRouter {
  ...
  late final GoRouter router = GoRouter(
    ...
    observers: <NavigatorObserver>[LoggingNavigatorObserver()],
...
class LoggingNavigatorObserver extends NavigatorObserver {
  void _log(String event, Route<dynamic>? to, Route<dynamic>? from) {
    debugPrint('[Nav] $event: ${from?.settings.name} -> ${to?.settings.name}');
  }
  ...
  @override
  void didPop(Route<dynamic> route, Route<dynamic>? previousRoute) => _log('POP', previousRoute, route);
