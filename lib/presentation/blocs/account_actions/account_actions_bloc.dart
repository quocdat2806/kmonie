...
class AccountActionsBloc
    extends Bloc<AccountActionsEvent, AccountActionsState> {
  AccountActionsBloc(this._accountRepository)
  ...
  Future<void> _onLoadAccounts(
    ...
    Emitter<AccountActionsState> emit,
  ) async {
    final result = await _accountRepository.getAllAccounts();
    result.fold(
      (f) => emit(const AccountActionsState()),
      (accounts) => emit(AccountActionsState(accounts: accounts)),
    );
  }
  ...
  Future<void> _onUpdateAccountBalance(
    ...
    final result = await _accountRepository.updateAccountBalance(
      event.accountId,
      event.newBalance,
    );
    result.fold(
  ...
  void _onAccountsStreamUpdated(
    AccountsStreamUpdated event,
    Emitter<AccountActionsState> emit,
  ) {
