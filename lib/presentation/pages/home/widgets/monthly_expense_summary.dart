...
import 'package:kmonie/presentation/bloc/home/home_export.dart';
          ...
          children: <Widget>[
            ...
            Expanded(
              child: _buildSummaryItem(
                ...
                FormatUtils.formatCurrency(data.totalExpense.toInt()),
              ),
            ),
            Expanded(
              child: _buildSummaryItem(
                AppTextConstants.income,
                FormatUtils.formatCurrency(data.totalIncome.toInt()),
              ),
            ),
            Expanded(
              child: _buildSummaryItem(
                AppTextConstants.balance,
                FormatUtils.formatCurrency(data.totalBalance.toInt()),
              ),
            ),
          ],
        );
