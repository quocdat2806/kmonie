      ...
      builder: (context, data) {
        ...
        return Row(
          children: <Widget>[
              ...
              child: InkWell(
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    ...
                    Row(
                      children: <Widget>[
                        Text('${TextConstants.month} $month', style: AppTextStyle.blackS14),
            ...
            Expanded(child: _buildSummaryItem(TextConstants.expense, FormatUtils.formatAmount(data.totalExpense.toInt()))),
            Expanded(child: _buildSummaryItem(TextConstants.income, FormatUtils.formatAmount(data.totalIncome.toInt()))),
            Expanded(child: _buildSummaryItem(TextConstants.balance, FormatUtils.formatAmount(data.totalBalance.toInt()))),
          ],
        );
      },
    );
