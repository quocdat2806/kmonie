...
class MonthlyStatisticsReport extends StatelessWidget {
  const MonthlyStatisticsReport({super.key});
  ...
  Widget build(BuildContext context) {
    return InkWell(
      ...
      onTap: () =>
          AppNavigator(context: context).push(RouterPath.monthlyStatistics),
      child: Container(
        ...
        child: Column(
          ...
          children: [
            Row(
              ...
              children: [
                Text(
                  AppTextConstants.monthlyStatistics,
