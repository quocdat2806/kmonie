...
class MonthlyBudgetSummary extends StatelessWidget {
  ...
  final bool useOverBudgetColors; // when true, show red background when over budget (as in report)
  final bool alignRight; // controls info alignment (right in budget page, left in report)
            ...
            children: [
              Transform.rotate(
                ...
                child: SizedBox(
                  width: 80,
                  height: 80,
                  child: CircularProgressIndicator(value: progress, strokeWidth: 8, backgroundColor: isOverBudget && useOverBudgetColors ? Colors.red : AppColorConstants.primary, valueColor: AlwaysStoppedAnimation<Color>(isOverBudget && useOverBudgetColors ? Colors.red.shade700 : Colors.grey), strokeCap: StrokeCap.butt),
                ),
              ),
              Center(
                child: Column(
                  ...
                  children: [
                    ...
                    Text(isOverBudget && useOverBudgetColors ? '100.0%' : '${(isOverBudget ? (progress * 100) : (100 - progress * 100)).toStringAsFixed(1)}%', style: AppTextStyle.blackS12Medium),
                  ],
                ),
              ),
            ],
