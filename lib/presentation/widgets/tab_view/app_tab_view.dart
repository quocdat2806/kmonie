        ...
        return Expanded(
          child: InkWell(
            ...
            child: DecoratedBox(
              ...
              child: Padding(
                padding: const EdgeInsets.symmetric(vertical: AppUIConstants.smallPadding + AppUIConstants.extraSmallSpacing),
                child: Text(getDisplayName(type), textAlign: TextAlign.center, style: isSelected ? AppTextStyle.yellowS14Medium : AppTextStyle.blackS14Medium),
              ),
            ),
          ),
        );
